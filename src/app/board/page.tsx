            ...
            <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-4 md:grid-rows-2 gap-4 h-full min-h-[600px]">
                ...
                >
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        <div>
                            <div className="bg-white/50 w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform">
                ...
                >
                    <div className="relative z-10 flex flex-col h-full justify-center pl-0 md:pl-8">
                        <div className="bg-white/50 w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <ArrowUpRight className="text-[#4F3457]" size={20} />
                        </div>
                ...
                >
                    <div className="relative z-10 flex flex-col justify-between h-full bg-transparent">
                        <div>
                            <div className="bg-white/50 w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform self-start">
                                <ArrowUpRight className="text-[#4F3457]" size={20} />
                            </div>
