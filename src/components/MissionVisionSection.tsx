...
export default function MissionVisionSection() {
    return (
        ...
        >
            ...
            <div className="flex-grow flex items-center md:items-end justify-center px-4 md:px-8 z-20 pb-0 mt-2 md:mt-12 mb-8 md:mb-0">
                <div className="relative w-full max-w-[1200px] bg-white/20 backdrop-blur-md border border-white/40 border-b-0 rounded-t-[2rem] md:rounded-t-[2.5rem] rounded-b-[2rem] md:rounded-b-none p-4 md:p-8 pb-4 md:pb-0 shadow-xl h-full flex flex-col justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 h-full">
                        ...
                        {/* Vision Card */}
                        <div className="bg-white/60 rounded-t-[1.5rem] md:rounded-t-[2rem] rounded-b-[1.5rem] md:rounded-b-none p-4 md:p-12 pb-4 md:pb-40 flex flex-col justify-start pt-6 md:pt-16 gap-2 md:gap-3 shadow-inner h-full">
                            <h3 className={`${inter.className} text-[#5E4175] text-2xl md:text-5xl lg:text-5xl font-bold lowercase tracking-tight text-left md:text-right`}>our vision</h3>
                            <p className={`${inter.className} text-[#4F3457] text-sm md:text-sm lg:text-lg leading-relaxed text-left md:text-right`}>
